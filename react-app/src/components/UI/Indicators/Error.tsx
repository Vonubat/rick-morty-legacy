  ...
  render(): JSX.Element {
    return (
      <div className="flex flex-col justify-center items-center text-center mx-3 my-3">
        ...
        />
        <h2 className="text-3xl text-blue-600 font-mono mt-3 z-50">Nobody exists on purpose.</h2>
        <h2 className="text-3xl text-blue-600 font-mono mt-3 z-50">Nobody belongs anywhere.</h2>
        <h2 className="text-3xl text-blue-600 font-mono mt-3 z-50">
