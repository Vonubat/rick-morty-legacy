  ...
  render(): JSX.Element {
    return (
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-screen h-screen bg-white bg-opacity-80 z-40">
        <div className="fixed text-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
          <Lottie
            loop
          ...
          />
          <h2 className="text-3xl text-blue-600 font-mono mt-3 z-50">Loading...</h2>
        </div>
      </div>
    );
  }
