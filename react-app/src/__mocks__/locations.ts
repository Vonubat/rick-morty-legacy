import { ILocationContent } from 'types/models';

// Mock API locations data (https://rickandmortyapi.com/documentation/#location-schema)

export const locations: ILocationContent[] = [
  {
    info: {
      count: 126,
      pages: 7,
  ...
  },
  {
    info: {
      count: 126,
      pages: 7,
      next: 'https://rickandmortyapi.com/api/location/?page=4',
  ...
  },
  {
    info: {
      count: 126,
      pages: 7,
      next: 'https://rickandmortyapi.com/api/location/?page=5',
      prev: 'https://rickandmortyapi.com/api/location/?page=3',
    },
    results: [
      {
        id: 61,
  ...
  },
  {
    info: {
      count: 126,
      pages: 7,
      next: 'https://rickandmortyapi.com/api/location/?page=6',
      prev: 'https://rickandmortyapi.com/api/location/?page=4',
    },
    results: [
      {
        id: 81,
  ...
  },
  {
    info: {
      count: 126,
      pages: 7,
      next: 'https://rickandmortyapi.com/api/location/?page=7',
      prev: 'https://rickandmortyapi.com/api/location/?page=5',
    },
    results: [
      {
        id: 101,
